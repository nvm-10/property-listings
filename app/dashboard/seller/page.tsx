        ...
        >
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Add your property listing</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <label className="aspect-square border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-[--primary] hover:bg-blue-50 transition-all">
